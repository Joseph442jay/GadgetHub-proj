...
export default function CheckoutPage() {
  ...
  async function paystackCallback(response, orderId) {
    try {
      await axios.post("https://gadgethub-backend-qn4a.onrender.com/api/payments/verify", {
        reference: response.reference,
      });

      await axios.patch(`https://gadgethub-backend-qn4a.onrender.com/api/orders/${orderId}/payment`, {
        paymentStatus: "paid",
  ...
  const handleCreditCardPayment = async (orderId, amount) => {
    ...
    try {
      const { data } = await axios.post("https://gadgethub-backend-qn4a.onrender.com/api/payments/card-init", {
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      const orderRes = await axios.post(
        "https://gadgethub-backend-qn4a.onrender.com/api/orders/",
        {
      ...
      if (orderData.paymentMethod === "paystack" || orderData.paymentMethod === "paypal") {
        const paymentRes = await axios.post("https://gadgethub-backend-qn4a.onrender.com/api/payments/initialize", {
          orderId,
