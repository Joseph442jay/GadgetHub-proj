    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      ...
      <div className="bg-white rounded-xl shadow-lg w-[99%] max-w-md relative max-h-[600px] overflow-y-auto">
        ...
        <form
          ...
          className="border-t border-b border-[#E7E4E4] py-5 px-6"
          action=""
        >
          ...
          <input
            ...
            className="w-full p-3 h-11 rounded-md text-[#A3A2A2] border my-2"
          ...
          <div className="w-full flex justify-between gap-5">
            <div className="w-1/2">
              <label className="text-[14px] font-semibold" htmlFor="category">
                Category *
              </label>
              <select
                name="category"
            ...
            <div className="w-1/2">
              <label className="text-[14px] font-semibold" htmlFor="brand">
                Brand Name *
              </label>
              <input
                name="brand"
          ...
          <label className="text-[14px] font-semibold" htmlFor="price">
            Price *
          </label>
          <input
            name="price"
          ...
          <p className="text-[14px] font-semibold mt-4 mb-2">
            {" "}
            ...
            {specs.map((spec, index) => (
              <div key={index} className="flex gap-3 items-center">
                <input
                  ...
                  className="w-1/2 p-3 h-11 rounded-md border text-sm"
                  value={spec.key}
                  onChange={(e) => updateSpec(index, "key", e.target.value)}
                />
                <input
                  type="text"
                  placeholder="Spec value (e.g 6.7 OLED)"
                  className="w-1/2 p-3 h-11 rounded-md border text-sm"
                  value={spec.value}
          ...
          <button
            type="button"
            onClick={addSpec}
            className="mt-3 text-[#6C4CF1] text-sm font-semibold"
          >
            {" "}
            + Add Specification
          </button>
          ...
          <label
            className="text-[14px] font-semibold block my-2"
            htmlFor="image"
          >
            Product Image *
          </label>
          ...
          <div
            ...
            className="border border-[#E6EFF5] rounded-md p-6 text-center cursor-pointer hover:bg-[#F3F0FF] transition"
          ...
          >
            {preview ? (
              ...
              <div className="flex flex-col mx-auto items-center justify-center gap-2">
                ...
                <p className="text-[14px] text-[#494747]">
                  {" "}
                  Drag & drop product image here or click to upload (JPG/PNG,
                  max 5mb)
                </p>
              </div>
            )}
          ...
          <div className="flex justify-between gap-8 py-5 px-6">
            <Button
              type="submit"
              className="text-white hover:bg-[#6b51cf] h-12 w-[267px]"
              content="Update Product"
            />
            <button
              type="button"
              onClick={closeModal}
              className="text-[#EE2020] border border-[#EE2020] h-12 w-[267px] hover:text-[white] hover:bg-[#EE2020] rounded-md"
            >
              Cancel
            </button>
          </div>
